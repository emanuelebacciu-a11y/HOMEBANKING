...
const RvIconAI = ({ color = '#FFFFFF', size = 34 } = {}) => (
  <svg width={size} height={size} viewBox="0 0 32 32" overflow="hidden" style={{ color }}>
    <circle cx="17.91" cy="10.02" r="0.11" fill="currentColor" opacity="0.91"/>
    <circle cx="21.69" cy="21.02" r="0.16" fill="currentColor" opacity="0.81"/>
    <circle cx="21.33" cy="22.92" r="0.15" fill="currentColor" opacity="0.93"/>
    <circle cx="26.59" cy="17.91" r="0.1" fill="currentColor" opacity="0.91"/>
    <circle cx="5.95" cy="15.54" r="0.11" fill="currentColor" opacity="0.66"/>
    <circle cx="24.29" cy="21.06" r="0.15" fill="currentColor" opacity="0.6"/>
    <circle cx="17.12" cy="18.92" r="0.11" fill="currentColor" opacity="0.78"/>
    <circle cx="7.47" cy="19.53" r="0.09" fill="currentColor" opacity="0.92"/>
    <circle cx="25.4" cy="14.94" r="0.18" fill="currentColor" opacity="0.92"/>
    <circle cx="22.18" cy="20.2" r="0.09" fill="currentColor" opacity="0.89"/>
    <circle cx="12.51" cy="15.15" r="0.14" fill="currentColor" opacity="0.89"/>
    <circle cx="12.37" cy="14.77" r="0.21" fill="currentColor" opacity="0.53"/>
    <circle cx="21.99" cy="6.95" r="0.19" fill="currentColor" opacity="0.97"/>
    <circle cx="10.95" cy="15.0" r="0.15" fill="currentColor" opacity="0.87"/>
    <circle cx="16.79" cy="9.23" r="0.21" fill="currentColor" opacity="0.52"/>
    <circle cx="13.82" cy="16.06" r="0.13" fill="currentColor" opacity="0.99"/>
    <circle cx="24.06" cy="23.37" r="0.21" fill="currentColor" opacity="0.84"/>
    <circle cx="23.09" cy="18.6" r="0.18" fill="currentColor" opacity="0.55"/>
    <circle cx="15.01" cy="19.18" r="0.2" fill="currentColor" opacity="0.96"/>
    <circle cx="24.46" cy="11.6" r="0.16" fill="currentColor" opacity="0.53"/>
    <circle cx="6.47" cy="17.12" r="0.19" fill="currentColor" opacity="0.51"/>
    <circle cx="19.26" cy="16.17" r="0.21" fill="currentColor" opacity="0.56"/>
    <circle cx="10.15" cy="20.83" r="0.2" fill="currentColor" opacity="0.57"/>
    <circle cx="15.3" cy="25.64" r="0.09" fill="currentColor" opacity="0.58"/>
    <circle cx="26.63" cy="17.69" r="0.11" fill="currentColor" opacity="0.75"/>
    <circle cx="8.09" cy="23.5" r="0.18" fill="currentColor" opacity="0.8"/>
    <circle cx="10.32" cy="16.37" r="0.2" fill="currentColor" opacity="0.55"/>
    <circle cx="11.69" cy="11.86" r="0.12" fill="currentColor" opacity="0.73"/>
    <circle cx="19.16" cy="23.85" r="0.09" fill="currentColor" opacity="0.51"/>
    <circle cx="18.08" cy="18.56" r="0.2" fill="currentColor" opacity="0.76"/>
    <circle cx="11.8" cy="7.25" r="0.1" fill="currentColor" opacity="0.98"/>
    <circle cx="10.42" cy="20.96" r="0.15" fill="currentColor" opacity="0.85"/>
    <circle cx="16.56" cy="11.19" r="0.2" fill="currentColor" opacity="0.71"/>
    <circle cx="15.93" cy="26.23" r="0.2" fill="currentColor" opacity="0.93"/>
    <circle cx="11.32" cy="25.41" r="0.19" fill="currentColor" opacity="0.99"/>
    <circle cx="16.34" cy="5.01" r="0.15" fill="currentColor" opacity="0.87"/>
    <circle cx="17.55" cy="8.19" r="0.15" fill="currentColor" opacity="0.7"/>
    <circle cx="20.59" cy="11.02" r="0.18" fill="currentColor" opacity="0.78"/>
    <circle cx="14.36" cy="10.11" r="0.09" fill="currentColor" opacity="0.84"/>
    <circle cx="20.04" cy="21.21" r="0.19" fill="currentColor" opacity="0.52"/>
    <circle cx="23.16" cy="11.52" r="0.16" fill="currentColor" opacity="0.84"/>
    <circle cx="17.53" cy="16.57" r="0.18" fill="currentColor" opacity="0.79"/>
    <circle cx="9.61" cy="8.33" r="0.12" fill="currentColor" opacity="0.58"/>
    <circle cx="18.65" cy="15.48" r="0.15" fill="currentColor" opacity="0.81"/>
    <circle cx="19.11" cy="15.1" r="0.18" fill="currentColor" opacity="0.54"/>
    <circle cx="7.7" cy="18.48" r="0.2" fill="currentColor" opacity="0.52"/>
    <circle cx="15.96" cy="11.76" r="0.14" fill="currentColor" opacity="0.99"/>
    <circle cx="17.8" cy="13.54" r="0.08" fill="currentColor" opacity="0.52"/>
    <circle cx="16.42" cy="13.89" r="0.19" fill="currentColor" opacity="0.9"/>
    <circle cx="20.39" cy="6.3" r="0.17" fill="currentColor" opacity="0.91"/>
    <circle cx="7.33" cy="13.61" r="0.09" fill="currentColor" opacity="0.78"/>
    <circle cx="22.84" cy="15.58" r="0.18" fill="currentColor" opacity="0.59"/>
    <circle cx="7.96" cy="16.93" r="0.19" fill="currentColor" opacity="0.66"/>
    <circle cx="11.3" cy="16.93" r="0.16" fill="currentColor" opacity="0.97"/>
    <circle cx="9.24" cy="21.84" r="0.16" fill="currentColor" opacity="0.6"/>
    <circle cx="14.33" cy="11.22" r="0.17" fill="currentColor" opacity="1.0"/>
    <circle cx="12.86" cy="24.43" r="0.13" fill="currentColor" opacity="0.82"/>
    <circle cx="18.81" cy="23.26" r="0.19" fill="currentColor" opacity="0.61"/>
    <circle cx="12.81" cy="20.14" r="0.1" fill="currentColor" opacity="0.84"/>
    <circle cx="19.9" cy="9.04" r="0.14" fill="currentColor" opacity="0.65"/>
    <circle cx="16.72" cy="26.65" r="0.15" fill="currentColor" opacity="0.84"/>
    <circle cx="15.17" cy="20.5" r="0.08" fill="currentColor" opacity="0.65"/>
    <circle cx="9.06" cy="19.87" r="0.17" fill="currentColor" opacity="0.85"/>
    <circle cx="23.03" cy="9.1" r="0.18" fill="currentColor" opacity="0.9"/>
    <circle cx="8.7" cy="14.04" r="0.21" fill="currentColor" opacity="0.95"/>
    <circle cx="8.28" cy="22.73" r="0.14" fill="currentColor" opacity="0.88"/>
    <circle cx="24.39" cy="17.28" r="0.21" fill="currentColor" opacity="0.72"/>
    <circle cx="22.24" cy="9.41" r="0.08" fill="currentColor" opacity="0.54"/>
    <circle cx="10.74" cy="25.48" r="0.17" fill="currentColor" opacity="0.8"/>
    <circle cx="20.15" cy="10.98" r="0.1" fill="currentColor" opacity="0.72"/>
    <circle cx="19.75" cy="13.56" r="0.15" fill="currentColor" opacity="0.65"/>
    <circle cx="13.91" cy="18.61" r="0.21" fill="currentColor" opacity="0.63"/>
    <circle cx="17.11" cy="11.56" r="0.14" fill="currentColor" opacity="0.51"/>
    <circle cx="9.33" cy="11.86" r="0.14" fill="currentColor" opacity="0.6"/>
    <circle cx="14.66" cy="14.42" r="0.21" fill="currentColor" opacity="0.74"/>
    <circle cx="10.51" cy="11.4" r="0.08" fill="currentColor" opacity="0.52"/>
    <circle cx="14.83" cy="8.42" r="0.12" fill="currentColor" opacity="0.77"/>
    <circle cx="21.41" cy="10.31" r="0.15" fill="currentColor" opacity="0.79"/>
    <circle cx="17.37" cy="14.61" r="0.17" fill="currentColor" opacity="0.79"/>
    <circle cx="15.06" cy="11.63" r="0.2" fill="currentColor" opacity="0.9"/>
    <circle cx="14.17" cy="26.55" r="0.09" fill="currentColor" opacity="0.77"/>
    <circle cx="20.09" cy="18.47" r="0.17" fill="currentColor" opacity="0.85"/>
    <circle cx="10.6" cy="16.71" r="0.16" fill="currentColor" opacity="0.72"/>
    <circle cx="10.76" cy="20.71" r="0.14" fill="currentColor" opacity="0.68"/>
    <circle cx="21.57" cy="21.39" r="0.12" fill="currentColor" opacity="0.9"/>
    <circle cx="25.13" cy="13.38" r="0.13" fill="currentColor" opacity="0.74"/>
    <circle cx="15.64" cy="10.75" r="0.19" fill="currentColor" opacity="0.52"/>
    <circle cx="24.04" cy="14.35" r="0.19" fill="currentColor" opacity="0.8"/>
    <circle cx="20.17" cy="10.19" r="0.09" fill="currentColor" opacity="0.6"/>
    <circle cx="15.73" cy="5.09" r="0.11" fill="currentColor" opacity="0.74"/>
    <circle cx="17.17" cy="10.04" r="0.11" fill="currentColor" opacity="0.88"/>
    <circle cx="20.72" cy="20.25" r="0.16" fill="currentColor" opacity="0.75"/>
    <circle cx="23.26" cy="13.58" r="0.14" fill="currentColor" opacity="0.59"/>
    <circle cx="17.0" cy="13.75" r="0.08" fill="currentColor" opacity="0.68"/>
    <circle cx="17.87" cy="10.77" r="0.15" fill="currentColor" opacity="0.55"/>
    <circle cx="14.02" cy="26.48" r="0.2" fill="currentColor" opacity="0.55"/>
    <circle cx="23.24" cy="13.92" r="0.1" fill="currentColor" opacity="0.68"/>
    <circle cx="20.57" cy="14.88" r="0.19" fill="currentColor" opacity="0.97"/>
    <circle cx="24.24" cy="11.15" r="0.21" fill="currentColor" opacity="0.56"/>
    <circle cx="12.34" cy="5.85" r="0.15" fill="currentColor" opacity="0.51"/>
    <circle cx="14.18" cy="23.08" r="0.14" fill="currentColor" opacity="0.86"/>
    <circle cx="16.41" cy="16.8" r="0.17" fill="currentColor" opacity="0.99"/>
    <circle cx="6.97" cy="16.94" r="0.18" fill="currentColor" opacity="0.84"/>
    <circle cx="16.52" cy="14.16" r="0.18" fill="currentColor" opacity="0.72"/>
    <circle cx="8.55" cy="22.46" r="0.1" fill="currentColor" opacity="0.96"/>
    <circle cx="19.82" cy="6.71" r="0.21" fill="currentColor" opacity="0.61"/>
    <circle cx="7.3" cy="10.19" r="0.16" fill="currentColor" opacity="0.84"/>
    <circle cx="23.12" cy="21.49" r="0.08" fill="currentColor" opacity="0.76"/>
    <circle cx="22.01" cy="17.05" r="0.1" fill="currentColor" opacity="0.64"/>
    <circle cx="22.26" cy="22.58" r="0.15" fill="currentColor" opacity="0.89"/>
    <circle cx="19.46" cy="7.4" r="0.16" fill="currentColor" opacity="0.76"/>
    <circle cx="16.93" cy="8.83" r="0.13" fill="currentColor" opacity="0.7"/>
    <circle cx="20.97" cy="16.78" r="0.17" fill="currentColor" opacity="0.7"/>
    <circle cx="12.95" cy="17.51" r="0.1" fill="currentColor" opacity="0.94"/>
    <circle cx="18.05" cy="9.74" r="0.21" fill="currentColor" opacity="0.79"/>
    <circle cx="15.96" cy="11.69" r="0.21" fill="currentColor" opacity="0.73"/>
    <circle cx="17.84" cy="18.17" r="0.09" fill="currentColor" opacity="0.5"/>
    <circle cx="17.64" cy="6.33" r="0.12" fill="currentColor" opacity="0.65"/>
    <circle cx="20.52" cy="13.23" r="0.21" fill="currentColor" opacity="0.91"/>
    <circle cx="9.74" cy="20.01" r="0.14" fill="currentColor" opacity="0.68"/>
    <circle cx="13.41" cy="7.32" r="0.22" fill="currentColor" opacity="0.56"/>
    <circle cx="13.11" cy="23.46" r="0.19" fill="currentColor" opacity="1.0"/>
    <circle cx="17.44" cy="12.95" r="0.19" fill="currentColor" opacity="0.61"/>
    <circle cx="13.27" cy="17.26" r="0.08" fill="currentColor" opacity="0.71"/>
    <circle cx="20.27" cy="11.89" r="0.08" fill="currentColor" opacity="0.85"/>
    <circle cx="15.41" cy="19.16" r="0.11" fill="currentColor" opacity="0.94"/>
    <circle cx="22.29" cy="11.46" r="0.15" fill="currentColor" opacity="0.85"/>
    <circle cx="12.23" cy="21.69" r="0.19" fill="currentColor" opacity="0.83"/>
    <circle cx="22.32" cy="10.62" r="0.2" fill="currentColor" opacity="0.92"/>
    <circle cx="16.72" cy="24.78" r="0.16" fill="currentColor" opacity="0.58"/>
    <circle cx="17.3" cy="22.76" r="0.21" fill="currentColor" opacity="0.52"/>
    <circle cx="26.44" cy="13.58" r="0.14" fill="currentColor" opacity="0.81"/>
    <circle cx="15.26" cy="18.14" r="0.08" fill="currentColor" opacity="0.87"/>
    <circle cx="17.03" cy="23.78" r="0.12" fill="currentColor" opacity="0.5"/>
    <circle cx="10.18" cy="20.67" r="0.21" fill="currentColor" opacity="0.76"/>
    <circle cx="22.85" cy="14.74" r="0.2" fill="currentColor" opacity="0.76"/>
    <circle cx="26.44" cy="17.51" r="0.18" fill="currentColor" opacity="0.79"/>
    <circle cx="15.07" cy="16.39" r="0.2" fill="currentColor" opacity="0.53"/>
    <circle cx="23.56" cy="22.07" r="0.12" fill="currentColor" opacity="0.67"/>
    <circle cx="14.91" cy="23.44" r="0.19" fill="currentColor" opacity="0.67"/>
    <circle cx="21.57" cy="21.97" r="0.13" fill="currentColor" opacity="0.95"/>
    <circle cx="22.58" cy="18.72" r="0.14" fill="currentColor" opacity="0.9"/>
    <circle cx="19.75" cy="25.03" r="0.16" fill="currentColor" opacity="0.91"/>
    <circle cx="18.71" cy="8.69" r="0.18" fill="currentColor" opacity="0.57"/>
    <circle cx="16.13" cy="10.94" r="0.16" fill="currentColor" opacity="0.58"/>
    <circle cx="22.59" cy="13.75" r="0.17" fill="currentColor" opacity="0.75"/>
    <circle cx="14.2" cy="11.49" r="0.19" fill="currentColor" opacity="0.69"/>
    <circle cx="9.33" cy="7.73" r="0.17" fill="currentColor" opacity="0.88"/>
    <circle cx="8.46" cy="16.51" r="0.21" fill="currentColor" opacity="0.74"/>
    <circle cx="21.97" cy="17.47" r="0.15" fill="currentColor" opacity="0.51"/>
    <circle cx="22.77" cy="20.8" r="0.1" fill="currentColor" opacity="0.97"/>
    <circle cx="20.42" cy="20.19" r="0.09" fill="currentColor" opacity="0.69"/>
    <circle cx="24.59" cy="16.51" r="0.1" fill="currentColor" opacity="0.56"/>
    <circle cx="13.77" cy="18.96" r="0.12" fill="currentColor" opacity="0.97"/>
    <circle cx="12.17" cy="24.37" r="0.17" fill="currentColor" opacity="0.84"/>
    <circle cx="9.0" cy="18.07" r="0.17" fill="currentColor" opacity="0.57"/>
    <circle cx="19.43" cy="17.0" r="0.08" fill="currentColor" opacity="0.73"/>
    <circle cx="22.21" cy="20.01" r="0.16" fill="currentColor" opacity="0.62"/>
    <circle cx="12.44" cy="9.0" r="0.12" fill="currentColor" opacity="0.76"/>
    <circle cx="23.96" cy="17.7" r="0.1" fill="currentColor" opacity="0.97"/>
    <circle cx="8.47" cy="13.33" r="0.11" fill="currentColor" opacity="0.54"/>
    <circle cx="19.56" cy="21.44" r="0.1" fill="currentColor" opacity="0.94"/>
    <circle cx="13.86" cy="22.84" r="0.13" fill="currentColor" opacity="0.68"/>
    <circle cx="19.95" cy="24.19" r="0.2" fill="currentColor" opacity="0.78"/>
    <circle cx="17.09" cy="25.59" r="0.08" fill="currentColor" opacity="0.84"/>
    <circle cx="11.56" cy="17.87" r="0.22" fill="currentColor" opacity="0.54"/>
    <circle cx="12.17" cy="24.08" r="0.09" fill="currentColor" opacity="0.88"/>
    <circle cx="20.62" cy="16.03" r="0.2" fill="currentColor" opacity="0.52"/>
    <circle cx="19.01" cy="12.76" r="0.13" fill="currentColor" opacity="0.65"/>
    <circle cx="10.93" cy="8.87" r="0.1" fill="currentColor" opacity="0.63"/>
    <circle cx="5.52" cy="16.7" r="0.15" fill="currentColor" opacity="0.82"/>
    <circle cx="19.13" cy="7.5" r="0.2" fill="currentColor" opacity="0.69"/>
    <circle cx="15.57" cy="12.57" r="0.11" fill="currentColor" opacity="0.53"/>
    <circle cx="18.79" cy="12.36" r="0.15" fill="currentColor" opacity="0.67"/>
    <circle cx="15.25" cy="19.94" r="0.14" fill="currentColor" opacity="0.75"/>
    <circle cx="7.09" cy="14.37" r="0.2" fill="currentColor" opacity="0.77"/>
    <circle cx="11.57" cy="14.63" r="0.13" fill="currentColor" opacity="0.65"/>
    <circle cx="14.89" cy="12.26" r="0.15" fill="currentColor" opacity="0.62"/>
    <circle cx="19.58" cy="13.12" r="0.16" fill="currentColor" opacity="0.66"/>
    <circle cx="14.64" cy="15.03" r="0.19" fill="currentColor" opacity="0.64"/>
    <circle cx="9.25" cy="21.13" r="0.21" fill="currentColor" opacity="0.78"/>
    <circle cx="12.78" cy="15.51" r="0.1" fill="currentColor" opacity="0.59"/>
    <circle cx="16.94" cy="14.8" r="0.19" fill="currentColor" opacity="0.67"/>
    <circle cx="16.9" cy="8.54" r="0.21" fill="currentColor" opacity="0.69"/>
    <circle cx="19.41" cy="21.71" r="0.16" fill="currentColor" opacity="0.57"/>
    <circle cx="9.62" cy="8.2" r="0.08" fill="currentColor" opacity="0.99"/>
    <circle cx="11.67" cy="23.17" r="0.21" fill="currentColor" opacity="0.81"/>
    <circle cx="24.82" cy="12.6" r="0.2" fill="currentColor" opacity="0.89"/>
    <circle cx="10.68" cy="15.69" r="0.17" fill="currentColor" opacity="0.92"/>
    <circle cx="25.28" cy="19.37" r="0.14" fill="currentColor" opacity="0.6"/>
    <circle cx="23.73" cy="21.58" r="0.14" fill="currentColor" opacity="0.52"/>
    <circle cx="16.2" cy="18.38" r="0.12" fill="currentColor" opacity="0.58"/>
    <circle cx="13.31" cy="17.55" r="0.08" fill="currentColor" opacity="0.84"/>
    <circle cx="24.73" cy="12.66" r="0.1" fill="currentColor" opacity="0.98"/>
    <circle cx="21.54" cy="6.84" r="0.13" fill="currentColor" opacity="0.76"/>
    <circle cx="7.37" cy="9.22" r="0.21" fill="currentColor" opacity="0.66"/>
    <circle cx="24.38" cy="17.22" r="0.19" fill="currentColor" opacity="0.54"/>
    <circle cx="18.45" cy="13.98" r="0.18" fill="currentColor" opacity="0.89"/>
    <circle cx="21.75" cy="15.0" r="0.15" fill="currentColor" opacity="0.55"/>
    <circle cx="12.87" cy="5.67" r="0.21" fill="currentColor" opacity="0.51"/>
    <circle cx="23.8" cy="23.71" r="0.21" fill="currentColor" opacity="0.87"/>
    <circle cx="16.75" cy="8.86" r="0.17" fill="currentColor" opacity="0.95"/>
    <circle cx="9.52" cy="18.23" r="0.12" fill="currentColor" opacity="0.73"/>
    <circle cx="11.51" cy="13.3" r="0.1" fill="currentColor" opacity="0.61"/>
    <circle cx="19.04" cy="18.94" r="0.14" fill="currentColor" opacity="0.88"/>
    <circle cx="8.83" cy="21.52" r="0.15" fill="currentColor" opacity="0.77"/>
    <circle cx="19.82" cy="14.1" r="0.17" fill="currentColor" opacity="0.65"/>
    <circle cx="12.59" cy="23.97" r="0.22" fill="currentColor" opacity="0.51"/>
    <circle cx="12.74" cy="25.97" r="0.11" fill="currentColor" opacity="0.73"/>
    <circle cx="16.38" cy="20.02" r="0.18" fill="currentColor" opacity="0.94"/>
    <circle cx="10.34" cy="8.65" r="0.12" fill="currentColor" opacity="0.93"/>
    <circle cx="13.22" cy="20.42" r="0.16" fill="currentColor" opacity="0.59"/>
    <circle cx="19.4" cy="9.93" r="0.2" fill="currentColor" opacity="0.82"/>
    <circle cx="20.45" cy="15.17" r="0.11" fill="currentColor" opacity="0.8"/>
    <circle cx="16.46" cy="24.23" r="0.12" fill="currentColor" opacity="0.84"/>
    <circle cx="18.82" cy="5.88" r="0.18" fill="currentColor" opacity="0.6"/>
    <circle cx="15.89" cy="26.52" r="0.17" fill="currentColor" opacity="0.56"/>
    <circle cx="13.05" cy="10.84" r="0.19" fill="currentColor" opacity="0.54"/>
    <circle cx="19.09" cy="10.88" r="0.22" fill="currentColor" opacity="0.98"/>
    <circle cx="15.38" cy="25.94" r="0.14" fill="currentColor" opacity="0.98"/>
    <circle cx="7.96" cy="19.93" r="0.21" fill="currentColor" opacity="0.52"/>
    <circle cx="5.3" cy="15.43" r="0.21" fill="currentColor" opacity="0.96"/>
    <circle cx="8.58" cy="10.07" r="0.2" fill="currentColor" opacity="0.73"/>
    <circle cx="25.51" cy="17.86" r="0.2" fill="currentColor" opacity="0.74"/>
    <circle cx="14.43" cy="14.25" r="0.21" fill="currentColor" opacity="0.74"/>
    <circle cx="18.94" cy="21.27" r="0.12" fill="currentColor" opacity="0.69"/>
    <circle cx="7.49" cy="19.46" r="0.2" fill="currentColor" opacity="0.55"/>
    <circle cx="7.43" cy="11.67" r="0.13" fill="currentColor" opacity="0.67"/>
    <circle cx="22.87" cy="19.76" r="0.1" fill="currentColor" opacity="0.83"/>
    <circle cx="26.59" cy="17.48" r="0.17" fill="currentColor" opacity="0.59"/>
    <circle cx="10.43" cy="14.98" r="0.14" fill="currentColor" opacity="0.91"/>
    <circle cx="20.09" cy="8.51" r="0.18" fill="currentColor" opacity="0.79"/>
    <circle cx="26.46" cy="18.7" r="0.1" fill="currentColor" opacity="0.88"/>
    <circle cx="5.79" cy="15.79" r="0.11" fill="currentColor" opacity="0.87"/>
    <circle cx="20.44" cy="12.39" r="0.12" fill="currentColor" opacity="0.92"/>
    <circle cx="9.31" cy="17.94" r="0.16" fill="currentColor" opacity="0.87"/>
    <circle cx="26.89" cy="16.63" r="0.14" fill="currentColor" opacity="0.5"/>
    <circle cx="9.78" cy="12.32" r="0.13" fill="currentColor" opacity="0.78"/>
    <circle cx="23.58" cy="20.62" r="0.12" fill="currentColor" opacity="0.85"/>
    <circle cx="14.96" cy="22.12" r="0.22" fill="currentColor" opacity="0.91"/>
    <circle cx="11.31" cy="11.45" r="0.1" fill="currentColor" opacity="0.8"/>
    <circle cx="6.9" cy="19.9" r="0.08" fill="currentColor" opacity="0.79"/>
    <circle cx="23.68" cy="17.57" r="0.14" fill="currentColor" opacity="0.69"/>
    <circle cx="21.51" cy="18.18" r="0.1" fill="currentColor" opacity="0.63"/>
    <circle cx="16.29" cy="10.36" r="0.2" fill="currentColor" opacity="0.69"/>
    <circle cx="19.82" cy="15.84" r="0.16" fill="currentColor" opacity="0.56"/>
    <circle cx="14.66" cy="11.75" r="0.13" fill="currentColor" opacity="0.94"/>
    <circle cx="15.86" cy="22.97" r="0.1" fill="currentColor" opacity="0.86"/>
    <circle cx="9.67" cy="14.15" r="0.17" fill="currentColor" opacity="0.81"/>
    <circle cx="23.49" cy="8.51" r="0.17" fill="currentColor" opacity="0.82"/>
    <circle cx="16.24" cy="16.24" r="0.1" fill="currentColor" opacity="0.78"/>
    <circle cx="20.28" cy="7.96" r="0.13" fill="currentColor" opacity="0.64"/>
    <circle cx="17.72" cy="14.93" r="0.21" fill="currentColor" opacity="0.89"/>
    <circle cx="20.87" cy="24.73" r="0.17" fill="currentColor" opacity="0.72"/>
    <circle cx="23.61" cy="23.76" r="0.14" fill="currentColor" opacity="0.89"/>
    <circle cx="22.98" cy="20.28" r="0.09" fill="currentColor" opacity="0.57"/>
    <circle cx="14.89" cy="7.65" r="0.15" fill="currentColor" opacity="0.51"/>
    <circle cx="20.22" cy="7.75" r="0.08" fill="currentColor" opacity="0.68"/>
    <circle cx="10.97" cy="12.48" r="0.14" fill="currentColor" opacity="0.58"/>
    <circle cx="16.67" cy="10.25" r="0.21" fill="currentColor" opacity="0.71"/>
    <circle cx="18.7" cy="14.95" r="0.11" fill="currentColor" opacity="0.88"/>
    <circle cx="16.98" cy="19.5" r="0.13" fill="currentColor" opacity="0.89"/>
    <circle cx="13.33" cy="7.11" r="0.15" fill="currentColor" opacity="0.75"/>
    <circle cx="13.94" cy="22.81" r="0.12" fill="currentColor" opacity="0.8"/>
    <circle cx="23.93" cy="11.72" r="0.21" fill="currentColor" opacity="0.62"/>
    <circle cx="9.48" cy="15.0" r="0.2" fill="currentColor" opacity="0.63"/>
    <circle cx="11.65" cy="15.6" r="0.08" fill="currentColor" opacity="0.95"/>
    <circle cx="13.52" cy="21.24" r="0.2" fill="currentColor" opacity="0.55"/>
    <circle cx="17.15" cy="18.47" r="0.17" fill="currentColor" opacity="0.63"/>
    <circle cx="19.72" cy="26.35" r="0.19" fill="currentColor" opacity="0.72"/>
    <circle cx="13.26" cy="12.61" r="0.18" fill="currentColor" opacity="0.88"/>
    <circle cx="8.03" cy="20.31" r="0.13" fill="currentColor" opacity="0.54"/>
    <circle cx="15.96" cy="20.65" r="0.17" fill="currentColor" opacity="0.68"/>
    <circle cx="16.51" cy="7.74" r="0.16" fill="currentColor" opacity="0.57"/>
    <circle cx="9.57" cy="13.66" r="0.17" fill="currentColor" opacity="0.99"/>
    <circle cx="13.66" cy="6.29" r="0.17" fill="currentColor" opacity="0.64"/>
    <circle cx="23.48" cy="19.81" r="0.1" fill="currentColor" opacity="0.51"/>
    <circle cx="25.16" cy="22.03" r="0.18" fill="currentColor" opacity="0.72"/>
    <circle cx="12.32" cy="18.71" r="0.15" fill="currentColor" opacity="0.78"/>
    <circle cx="19.02" cy="16.91" r="0.12" fill="currentColor" opacity="0.71"/>
    <circle cx="23.76" cy="8.4" r="0.09" fill="currentColor" opacity="0.92"/>
    <circle cx="16.92" cy="23.95" r="0.19" fill="currentColor" opacity="0.71"/>
    <circle cx="14.3" cy="6.61" r="0.12" fill="currentColor" opacity="0.62"/>
    <circle cx="24.94" cy="14.68" r="0.11" fill="currentColor" opacity="0.54"/>
    <circle cx="7.73" cy="18.83" r="0.2" fill="currentColor" opacity="0.55"/>
    <circle cx="19.03" cy="12.1" r="0.16" fill="currentColor" opacity="0.99"/>
    <circle cx="9.66" cy="17.47" r="0.16" fill="currentColor" opacity="0.54"/>
    <circle cx="23.43" cy="21.98" r="0.12" fill="currentColor" opacity="0.77"/>
    <circle cx="14.04" cy="24.9" r="0.09" fill="currentColor" opacity="0.53"/>
    <circle cx="15.4" cy="23.92" r="0.17" fill="currentColor" opacity="0.84"/>
    <circle cx="18.28" cy="21.52" r="0.2" fill="currentColor" opacity="0.93"/>
    <circle cx="5.84" cy="15.11" r="0.17" fill="currentColor" opacity="0.59"/>
    <circle cx="18.39" cy="13.06" r="0.1" fill="currentColor" opacity="0.88"/>
    <circle cx="22.95" cy="9.64" r="0.19" fill="currentColor" opacity="0.65"/>
    <circle cx="8.12" cy="22.12" r="0.13" fill="currentColor" opacity="0.56"/>
    <circle cx="15.04" cy="19.51" r="0.12" fill="currentColor" opacity="0.62"/>
    <circle cx="13.77" cy="19.11" r="0.21" fill="currentColor" opacity="0.55"/>
    <circle cx="11.23" cy="25.27" r="0.16" fill="currentColor" opacity="0.74"/>
    <circle cx="13.98" cy="5.4" r="0.12" fill="currentColor" opacity="0.78"/>
    <circle cx="12.48" cy="16.74" r="0.14" fill="currentColor" opacity="0.55"/>
    <circle cx="6.18" cy="16.58" r="0.19" fill="currentColor" opacity="0.55"/>
    <circle cx="11.41" cy="19.7" r="0.16" fill="currentColor" opacity="0.93"/>
    <circle cx="12.81" cy="12.69" r="0.09" fill="currentColor" opacity="0.58"/>
    <circle cx="12.67" cy="18.82" r="0.09" fill="currentColor" opacity="0.64"/>
    <circle cx="20.53" cy="24.17" r="0.22" fill="currentColor" opacity="0.82"/>
    <circle cx="17.23" cy="20.24" r="0.22" fill="currentColor" opacity="0.93"/>
    <circle cx="6.95" cy="16.56" r="0.21" fill="currentColor" opacity="0.85"/>
    <circle cx="9.76" cy="10.54" r="0.13" fill="currentColor" opacity="0.72"/>
    <circle cx="8.13" cy="20.01" r="0.17" fill="currentColor" opacity="0.52"/>
    <circle cx="19.48" cy="7.8" r="0.16" fill="currentColor" opacity="0.97"/>
    <circle cx="10.18" cy="17.51" r="0.11" fill="currentColor" opacity="0.65"/>
    <circle cx="9.12" cy="11.86" r="0.13" fill="currentColor" opacity="0.79"/>
    <circle cx="19.59" cy="6.23" r="0.22" fill="currentColor" opacity="0.63"/>
    <circle cx="19.97" cy="11.87" r="0.15" fill="currentColor" opacity="0.54"/>
    <circle cx="12.26" cy="7.99" r="0.18" fill="currentColor" opacity="0.94"/>
    <circle cx="18.02" cy="18.47" r="0.16" fill="currentColor" opacity="0.77"/>
    <circle cx="15.5" cy="22.49" r="0.13" fill="currentColor" opacity="0.86"/>
    <circle cx="10.01" cy="16.78" r="0.11" fill="currentColor" opacity="0.53"/>
    <circle cx="11.58" cy="13.01" r="0.14" fill="currentColor" opacity="0.59"/>
    <circle cx="8.27" cy="8.82" r="0.16" fill="currentColor" opacity="0.74"/>
    <circle cx="18.37" cy="22.09" r="0.17" fill="currentColor" opacity="0.81"/>
    <circle cx="6.83" cy="12.7" r="0.14" fill="currentColor" opacity="0.92"/>
    <circle cx="20.52" cy="13.86" r="0.18" fill="currentColor" opacity="0.71"/>
    <circle cx="18.37" cy="15.64" r="0.12" fill="currentColor" opacity="0.78"/>
    <circle cx="20.22" cy="13.12" r="0.1" fill="currentColor" opacity="0.92"/>
    <circle cx="15.42" cy="16.66" r="0.15" fill="currentColor" opacity="0.86"/>
    <circle cx="13.46" cy="7.17" r="0.21" fill="currentColor" opacity="0.83"/>
    <circle cx="12.83" cy="5.65" r="0.19" fill="currentColor" opacity="0.6"/>
    <circle cx="24.65" cy="19.44" r="0.15" fill="currentColor" opacity="0.74"/>
    <circle cx="18.32" cy="12.27" r="0.14" fill="currentColor" opacity="0.57"/>
    <circle cx="9.28" cy="11.28" r="0.11" fill="currentColor" opacity="0.88"/>
    <circle cx="15.98" cy="18.63" r="0.12" fill="currentColor" opacity="0.88"/>
    <circle cx="16.97" cy="9.15" r="0.18" fill="currentColor" opacity="0.61"/>
    <circle cx="16.47" cy="20.91" r="0.18" fill="currentColor" opacity="0.79"/>
    <circle cx="15.07" cy="7.65" r="0.12" fill="currentColor" opacity="0.84"/>
    <circle cx="15.89" cy="11.54" r="0.14" fill="currentColor" opacity="0.76"/>
    <circle cx="15.63" cy="5.15" r="0.12" fill="currentColor" opacity="0.52"/>
    <circle cx="19.47" cy="17.9" r="0.21" fill="currentColor" opacity="0.6"/>
    <circle cx="14.76" cy="23.26" r="0.15" fill="currentColor" opacity="0.88"/>
    <circle cx="14.11" cy="12.06" r="0.12" fill="currentColor" opacity="0.82"/>
    <circle cx="10.89" cy="24.22" r="0.15" fill="currentColor" opacity="0.65"/>
    <circle cx="17.2" cy="17.15" r="0.16" fill="currentColor" opacity="0.71"/>
    <circle cx="8.43" cy="14.76" r="0.21" fill="currentColor" opacity="0.68"/>
    <circle cx="6.49" cy="13.36" r="0.15" fill="currentColor" opacity="0.97"/>
    <circle cx="13.86" cy="23.21" r="0.16" fill="currentColor" opacity="0.75"/>
    <circle cx="11.82" cy="16.73" r="0.19" fill="currentColor" opacity="0.76"/>
    <circle cx="20.79" cy="14.02" r="0.1" fill="currentColor" opacity="0.91"/>
    <circle cx="22.07" cy="17.42" r="0.17" fill="currentColor" opacity="0.66"/>
    <circle cx="15.41" cy="20.96" r="0.18" fill="currentColor" opacity="0.8"/>
    <circle cx="18.11" cy="15.68" r="0.11" fill="currentColor" opacity="0.86"/>
  </svg>
);
