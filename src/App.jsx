...
const RvIconAI = ({ color = '#FFFFFF', size = 34 } = {}) => (
  <svg width={size} height={size} viewBox="0 0 32 32" overflow="hidden" style={{ color }}>
    <circle cx="11.4" cy="19.17" r="0.15" fill="currentColor" opacity="0.61"/>
    <circle cx="16.39" cy="9.75" r="0.2" fill="currentColor" opacity="0.84"/>
    <circle cx="4.25" cy="13.09" r="0.22" fill="currentColor" opacity="0.7"/>
    <circle cx="11.59" cy="12.2" r="0.32" fill="currentColor" opacity="0.67"/>
    <circle cx="8.12" cy="22.68" r="0.15" fill="currentColor" opacity="0.82"/>
    <circle cx="20.28" cy="10.11" r="0.33" fill="currentColor" opacity="0.75"/>
    <circle cx="17.31" cy="7.54" r="0.2" fill="currentColor" opacity="0.62"/>
    <circle cx="21.64" cy="16.27" r="0.34" fill="currentColor" opacity="0.76"/>
    <circle cx="4.47" cy="18.8" r="0.25" fill="currentColor" opacity="0.99"/>
    <circle cx="12.37" cy="20.53" r="0.32" fill="currentColor" opacity="0.56"/>
    <circle cx="18.51" cy="6.69" r="0.34" fill="currentColor" opacity="0.97"/>
    <circle cx="14.71" cy="13.97" r="0.12" fill="currentColor" opacity="0.73"/>
    <circle cx="17.51" cy="12.77" r="0.21" fill="currentColor" opacity="0.52"/>
    <circle cx="15.65" cy="16.88" r="0.19" fill="currentColor" opacity="0.75"/>
    <circle cx="19.37" cy="26.56" r="0.12" fill="currentColor" opacity="0.59"/>
    <circle cx="15.62" cy="23.94" r="0.29" fill="currentColor" opacity="0.66"/>
    <circle cx="11.93" cy="4.71" r="0.14" fill="currentColor" opacity="0.93"/>
    <circle cx="7.25" cy="9.67" r="0.25" fill="currentColor" opacity="0.69"/>
    <circle cx="19.89" cy="18.7" r="0.15" fill="currentColor" opacity="0.57"/>
    <circle cx="19.48" cy="20.51" r="0.24" fill="currentColor" opacity="0.88"/>
    <circle cx="19.41" cy="5.02" r="0.14" fill="currentColor" opacity="0.91"/>
    <circle cx="17.32" cy="19.09" r="0.18" fill="currentColor" opacity="0.78"/>
    <circle cx="21.55" cy="17.72" r="0.2" fill="currentColor" opacity="0.91"/>
    <circle cx="9.51" cy="20.75" r="0.2" fill="currentColor" opacity="0.53"/>
    <circle cx="24.73" cy="7.76" r="0.28" fill="currentColor" opacity="0.69"/>
    <circle cx="9.45" cy="18.41" r="0.26" fill="currentColor" opacity="0.82"/>
    <circle cx="11.65" cy="26.85" r="0.28" fill="currentColor" opacity="0.59"/>
    <circle cx="19.74" cy="6.44" r="0.17" fill="currentColor" opacity="0.63"/>
    <circle cx="16.03" cy="12.46" r="0.21" fill="currentColor" opacity="0.98"/>
    <circle cx="15.65" cy="24.86" r="0.32" fill="currentColor" opacity="0.93"/>
    <circle cx="18.17" cy="7.13" r="0.32" fill="currentColor" opacity="0.61"/>
    <circle cx="21.88" cy="10.58" r="0.26" fill="currentColor" opacity="0.8"/>
    <circle cx="13.93" cy="26.08" r="0.25" fill="currentColor" opacity="0.99"/>
    <circle cx="11.86" cy="8.82" r="0.2" fill="currentColor" opacity="0.94"/>
    <circle cx="10.24" cy="24.43" r="0.27" fill="currentColor" opacity="0.98"/>
    <circle cx="19.56" cy="25.55" r="0.15" fill="currentColor" opacity="0.81"/>
    <circle cx="10.07" cy="7.01" r="0.31" fill="currentColor" opacity="0.6"/>
    <circle cx="20.7" cy="10.35" r="0.2" fill="currentColor" opacity="0.54"/>
    <circle cx="15.56" cy="15.91" r="0.18" fill="currentColor" opacity="0.83"/>
    <circle cx="15.92" cy="10.89" r="0.29" fill="currentColor" opacity="0.71"/>
    <circle cx="19.0" cy="26.39" r="0.28" fill="currentColor" opacity="0.72"/>
    <circle cx="6.35" cy="14.09" r="0.26" fill="currentColor" opacity="0.88"/>
    <circle cx="16.66" cy="10.45" r="0.11" fill="currentColor" opacity="0.53"/>
    <circle cx="12.63" cy="24.91" r="0.33" fill="currentColor" opacity="0.7"/>
    <circle cx="9.65" cy="22.83" r="0.33" fill="currentColor" opacity="0.79"/>
    <circle cx="12.96" cy="26.44" r="0.34" fill="currentColor" opacity="0.89"/>
    <circle cx="11.83" cy="19.09" r="0.22" fill="currentColor" opacity="0.55"/>
    <circle cx="21.69" cy="22.11" r="0.31" fill="currentColor" opacity="0.84"/>
    <circle cx="5.37" cy="22.01" r="0.15" fill="currentColor" opacity="0.61"/>
    <circle cx="14.6" cy="25.36" r="0.31" fill="currentColor" opacity="0.68"/>
    <circle cx="21.61" cy="5.28" r="0.22" fill="currentColor" opacity="0.94"/>
    <circle cx="22.62" cy="10.47" r="0.15" fill="currentColor" opacity="0.52"/>
    <circle cx="16.55" cy="24.46" r="0.11" fill="currentColor" opacity="0.65"/>
    <circle cx="8.76" cy="16.27" r="0.28" fill="currentColor" opacity="0.78"/>
    <circle cx="6.26" cy="13.95" r="0.24" fill="currentColor" opacity="0.7"/>
    <circle cx="20.83" cy="24.28" r="0.12" fill="currentColor" opacity="0.5"/>
    <circle cx="12.71" cy="21.01" r="0.28" fill="currentColor" opacity="0.56"/>
    <circle cx="6.33" cy="19.89" r="0.21" fill="currentColor" opacity="0.9"/>
    <circle cx="19.84" cy="19.48" r="0.17" fill="currentColor" opacity="0.67"/>
    <circle cx="10.82" cy="13.96" r="0.24" fill="currentColor" opacity="0.84"/>
    <circle cx="9.52" cy="6.76" r="0.13" fill="currentColor" opacity="0.83"/>
    <circle cx="14.21" cy="4.79" r="0.14" fill="currentColor" opacity="0.52"/>
    <circle cx="16.58" cy="5.97" r="0.15" fill="currentColor" opacity="0.93"/>
    <circle cx="13.98" cy="6.41" r="0.28" fill="currentColor" opacity="0.8"/>
    <circle cx="14.46" cy="18.42" r="0.19" fill="currentColor" opacity="0.81"/>
    <circle cx="18.01" cy="20.9" r="0.14" fill="currentColor" opacity="0.74"/>
    <circle cx="26.45" cy="13.78" r="0.11" fill="currentColor" opacity="0.68"/>
    <circle cx="14.39" cy="12.46" r="0.29" fill="currentColor" opacity="0.6"/>
    <circle cx="5.55" cy="19.85" r="0.31" fill="currentColor" opacity="0.52"/>
    <circle cx="20.8" cy="5.33" r="0.3" fill="currentColor" opacity="0.88"/>
    <circle cx="11.11" cy="21.01" r="0.12" fill="currentColor" opacity="0.69"/>
    <circle cx="14.44" cy="20.73" r="0.33" fill="currentColor" opacity="0.94"/>
    <circle cx="18.49" cy="9.67" r="0.14" fill="currentColor" opacity="0.7"/>
    <circle cx="22.68" cy="19.26" r="0.25" fill="currentColor" opacity="0.65"/>
    <circle cx="12.38" cy="22.16" r="0.3" fill="currentColor" opacity="0.5"/>
    <circle cx="19.82" cy="7.01" r="0.24" fill="currentColor" opacity="0.84"/>
    <circle cx="27.53" cy="17.35" r="0.18" fill="currentColor" opacity="0.69"/>
    <circle cx="4.17" cy="15.09" r="0.16" fill="currentColor" opacity="0.75"/>
    <circle cx="21.75" cy="15.7" r="0.26" fill="currentColor" opacity="0.57"/>
    <circle cx="8.48" cy="12.62" r="0.24" fill="currentColor" opacity="0.49"/>
    <circle cx="19.52" cy="27.33" r="0.15" fill="currentColor" opacity="0.64"/>
    <circle cx="22.29" cy="15.57" r="0.24" fill="currentColor" opacity="0.7"/>
    <circle cx="26.03" cy="16.2" r="0.23" fill="currentColor" opacity="0.97"/>
    <circle cx="19.36" cy="15.5" r="0.25" fill="currentColor" opacity="0.66"/>
    <circle cx="24.08" cy="24.83" r="0.13" fill="currentColor" opacity="0.74"/>
    <circle cx="17.03" cy="25.4" r="0.16" fill="currentColor" opacity="0.92"/>
    <circle cx="10.83" cy="18.19" r="0.29" fill="currentColor" opacity="0.55"/>
    <circle cx="15.54" cy="9.79" r="0.3" fill="currentColor" opacity="0.61"/>
    <circle cx="10.05" cy="7.65" r="0.23" fill="currentColor" opacity="0.93"/>
    <circle cx="10.17" cy="14.38" r="0.23" fill="currentColor" opacity="0.84"/>
    <circle cx="8.04" cy="20.31" r="0.13" fill="currentColor" opacity="0.61"/>
    <circle cx="16.78" cy="8.82" r="0.15" fill="currentColor" opacity="0.89"/>
    <circle cx="18.4" cy="16.45" r="0.12" fill="currentColor" opacity="0.58"/>
    <circle cx="22.43" cy="18.09" r="0.17" fill="currentColor" opacity="0.96"/>
    <circle cx="15.71" cy="25.49" r="0.18" fill="currentColor" opacity="0.86"/>
    <circle cx="21.53" cy="20.82" r="0.14" fill="currentColor" opacity="0.64"/>
    <circle cx="15.45" cy="24.39" r="0.33" fill="currentColor" opacity="0.49"/>
    <circle cx="17.12" cy="25.68" r="0.3" fill="currentColor" opacity="0.68"/>
    <circle cx="11.55" cy="21.46" r="0.2" fill="currentColor" opacity="0.76"/>
    <circle cx="16.34" cy="14.2" r="0.15" fill="currentColor" opacity="0.6"/>
    <circle cx="8.09" cy="8.5" r="0.13" fill="currentColor" opacity="0.48"/>
    <circle cx="22.23" cy="21.42" r="0.27" fill="currentColor" opacity="0.99"/>
    <circle cx="10.44" cy="21.94" r="0.31" fill="currentColor" opacity="0.88"/>
    <circle cx="21.28" cy="12.37" r="0.27" fill="currentColor" opacity="0.9"/>
    <circle cx="15.1" cy="22.1" r="0.32" fill="currentColor" opacity="0.59"/>
    <circle cx="14.16" cy="19.55" r="0.31" fill="currentColor" opacity="0.8"/>
    <circle cx="16.36" cy="24.31" r="0.21" fill="currentColor" opacity="0.49"/>
    <circle cx="15.86" cy="12.52" r="0.2" fill="currentColor" opacity="0.86"/>
    <circle cx="13.8" cy="26.71" r="0.32" fill="currentColor" opacity="0.85"/>
    <circle cx="5.23" cy="21.42" r="0.18" fill="currentColor" opacity="1.0"/>
    <circle cx="8.78" cy="10.4" r="0.31" fill="currentColor" opacity="0.54"/>
    <circle cx="13.5" cy="26.72" r="0.13" fill="currentColor" opacity="0.96"/>
    <circle cx="7.62" cy="18.51" r="0.34" fill="currentColor" opacity="0.52"/>
    <circle cx="25.31" cy="17.17" r="0.26" fill="currentColor" opacity="0.93"/>
    <circle cx="20.16" cy="26.99" r="0.26" fill="currentColor" opacity="0.78"/>
    <circle cx="27.09" cy="17.37" r="0.16" fill="currentColor" opacity="0.83"/>
    <circle cx="17.41" cy="15.94" r="0.21" fill="currentColor" opacity="0.97"/>
    <circle cx="13.37" cy="27.14" r="0.3" fill="currentColor" opacity="0.84"/>
    <circle cx="26.5" cy="15.89" r="0.13" fill="currentColor" opacity="0.92"/>
    <circle cx="16.09" cy="8.23" r="0.13" fill="currentColor" opacity="0.62"/>
    <circle cx="9.83" cy="14.97" r="0.34" fill="currentColor" opacity="0.56"/>
    <circle cx="15.34" cy="20.34" r="0.28" fill="currentColor" opacity="0.91"/>
    <circle cx="15.96" cy="23.82" r="0.31" fill="currentColor" opacity="0.79"/>
    <circle cx="18.53" cy="28.22" r="0.29" fill="currentColor" opacity="0.64"/>
    <circle cx="7.63" cy="18.84" r="0.26" fill="currentColor" opacity="0.72"/>
    <circle cx="20.25" cy="21.78" r="0.14" fill="currentColor" opacity="0.74"/>
    <circle cx="8.67" cy="9.65" r="0.13" fill="currentColor" opacity="0.77"/>
    <circle cx="17.85" cy="6.72" r="0.19" fill="currentColor" opacity="0.89"/>
    <circle cx="7.01" cy="22.57" r="0.11" fill="currentColor" opacity="0.53"/>
    <circle cx="12.51" cy="16.95" r="0.15" fill="currentColor" opacity="0.97"/>
    <circle cx="17.14" cy="9.26" r="0.14" fill="currentColor" opacity="0.86"/>
    <circle cx="14.65" cy="10.98" r="0.24" fill="currentColor" opacity="0.81"/>
    <circle cx="19.54" cy="18.21" r="0.12" fill="currentColor" opacity="0.92"/>
    <circle cx="13.86" cy="22.91" r="0.12" fill="currentColor" opacity="0.82"/>
    <circle cx="15.99" cy="25.2" r="0.19" fill="currentColor" opacity="0.66"/>
    <circle cx="22.87" cy="17.9" r="0.32" fill="currentColor" opacity="0.97"/>
    <circle cx="25.88" cy="10.06" r="0.3" fill="currentColor" opacity="0.81"/>
    <circle cx="7.62" cy="9.51" r="0.33" fill="currentColor" opacity="0.79"/>
    <circle cx="6.02" cy="12.24" r="0.3" fill="currentColor" opacity="0.76"/>
    <circle cx="25.65" cy="17.25" r="0.19" fill="currentColor" opacity="0.55"/>
    <circle cx="24.76" cy="18.59" r="0.33" fill="currentColor" opacity="0.77"/>
    <circle cx="18.62" cy="11.51" r="0.19" fill="currentColor" opacity="0.98"/>
    <circle cx="12.0" cy="6.12" r="0.18" fill="currentColor" opacity="0.83"/>
    <circle cx="12.92" cy="20.64" r="0.15" fill="currentColor" opacity="0.57"/>
    <circle cx="22.53" cy="20.29" r="0.31" fill="currentColor" opacity="0.76"/>
    <circle cx="9.03" cy="23.18" r="0.32" fill="currentColor" opacity="0.61"/>
    <circle cx="26.8" cy="9.93" r="0.19" fill="currentColor" opacity="0.51"/>
    <circle cx="10.97" cy="5.12" r="0.19" fill="currentColor" opacity="0.64"/>
    <circle cx="16.36" cy="20.39" r="0.26" fill="currentColor" opacity="0.63"/>
    <circle cx="23.29" cy="12.75" r="0.14" fill="currentColor" opacity="0.83"/>
    <circle cx="20.47" cy="15.48" r="0.33" fill="currentColor" opacity="0.82"/>
    <circle cx="17.35" cy="3.92" r="0.24" fill="currentColor" opacity="0.76"/>
    <circle cx="21.02" cy="22.25" r="0.24" fill="currentColor" opacity="0.62"/>
    <circle cx="8.91" cy="19.11" r="0.3" fill="currentColor" opacity="0.66"/>
    <circle cx="20.75" cy="12.38" r="0.26" fill="currentColor" opacity="0.74"/>
    <circle cx="12.49" cy="26.46" r="0.34" fill="currentColor" opacity="0.55"/>
    <circle cx="17.24" cy="12.94" r="0.19" fill="currentColor" opacity="0.98"/>
    <circle cx="27.75" cy="13.38" r="0.19" fill="currentColor" opacity="0.86"/>
    <circle cx="19.15" cy="15.55" r="0.3" fill="currentColor" opacity="0.86"/>
    <circle cx="23.64" cy="12.53" r="0.26" fill="currentColor" opacity="0.88"/>
    <circle cx="5.41" cy="16.23" r="0.16" fill="currentColor" opacity="0.5"/>
    <circle cx="18.31" cy="28.19" r="0.21" fill="currentColor" opacity="0.94"/>
    <circle cx="27.76" cy="13.78" r="0.24" fill="currentColor" opacity="0.63"/>
    <circle cx="7.49" cy="9.07" r="0.28" fill="currentColor" opacity="0.5"/>
    <circle cx="18.12" cy="16.78" r="0.17" fill="currentColor" opacity="0.68"/>
    <circle cx="8.47" cy="23.88" r="0.29" fill="currentColor" opacity="0.63"/>
    <circle cx="9.15" cy="25.61" r="0.27" fill="currentColor" opacity="0.5"/>
    <circle cx="10.56" cy="25.95" r="0.23" fill="currentColor" opacity="0.58"/>
    <circle cx="7.15" cy="21.24" r="0.15" fill="currentColor" opacity="0.61"/>
    <circle cx="20.21" cy="9.44" r="0.2" fill="currentColor" opacity="0.99"/>
    <circle cx="22.65" cy="14.21" r="0.11" fill="currentColor" opacity="0.57"/>
    <circle cx="26.35" cy="14.39" r="0.16" fill="currentColor" opacity="0.95"/>
    <circle cx="23.56" cy="8.64" r="0.11" fill="currentColor" opacity="0.75"/>
    <circle cx="17.09" cy="22.23" r="0.2" fill="currentColor" opacity="0.69"/>
    <circle cx="21.71" cy="10.91" r="0.15" fill="currentColor" opacity="0.56"/>
    <circle cx="9.58" cy="17.49" r="0.3" fill="currentColor" opacity="0.81"/>
    <circle cx="15.39" cy="10.77" r="0.24" fill="currentColor" opacity="0.84"/>
    <circle cx="23.54" cy="18.36" r="0.26" fill="currentColor" opacity="0.56"/>
    <circle cx="21.55" cy="14.47" r="0.14" fill="currentColor" opacity="0.84"/>
    <circle cx="26.94" cy="14.99" r="0.23" fill="currentColor" opacity="0.65"/>
    <circle cx="16.68" cy="19.1" r="0.16" fill="currentColor" opacity="0.81"/>
    <circle cx="16.21" cy="28.43" r="0.15" fill="currentColor" opacity="0.61"/>
    <circle cx="5.79" cy="22.7" r="0.19" fill="currentColor" opacity="0.58"/>
    <circle cx="15.42" cy="12.38" r="0.22" fill="currentColor" opacity="0.59"/>
    <circle cx="24.18" cy="14.75" r="0.23" fill="currentColor" opacity="0.98"/>
    <circle cx="8.83" cy="5.82" r="0.21" fill="currentColor" opacity="0.93"/>
    <circle cx="9.97" cy="18.63" r="0.33" fill="currentColor" opacity="0.8"/>
    <circle cx="21.85" cy="23.39" r="0.27" fill="currentColor" opacity="0.55"/>
    <circle cx="7.72" cy="16.86" r="0.15" fill="currentColor" opacity="0.84"/>
    <circle cx="6.38" cy="16.78" r="0.23" fill="currentColor" opacity="0.8"/>
    <circle cx="17.58" cy="7.45" r="0.33" fill="currentColor" opacity="0.95"/>
    <circle cx="11.82" cy="17.23" r="0.22" fill="currentColor" opacity="0.68"/>
    <circle cx="21.36" cy="11.49" r="0.12" fill="currentColor" opacity="0.58"/>
    <circle cx="19.14" cy="12.97" r="0.32" fill="currentColor" opacity="0.7"/>
    <circle cx="5.5" cy="13.23" r="0.31" fill="currentColor" opacity="0.54"/>
    <circle cx="11.39" cy="13.13" r="0.33" fill="currentColor" opacity="0.88"/>
    <circle cx="15.82" cy="23.35" r="0.33" fill="currentColor" opacity="0.98"/>
    <circle cx="16.26" cy="13.55" r="0.16" fill="currentColor" opacity="0.79"/>
    <circle cx="18.42" cy="24.66" r="0.11" fill="currentColor" opacity="0.72"/>
    <circle cx="4.75" cy="17.69" r="0.19" fill="currentColor" opacity="0.95"/>
  </svg>
);
              ...
              <div className="rv-tab-icon">
                {isAI?(
                  <div className={`rv-orb-animated`} style={{
                    ...
                    <RvIconAI size={44} color={scheme==='dark'?'#FFFFFF':'#000000'}/>
                  </div>
                ):(
...
export default function App() {
  ...
  return (
    <div style={{
      ...
      <div style={{position:'fixed',left:'16px',right:'16px',zIndex:50,
